...
app.use(cors({
    ...
    allowedHeaders: [
        'Content-Type',
        'Authorization',
        'Cache-Control',   // axios sends this — was causing preflight failure
        'Pragma',          // sent alongside Cache-Control by some axios versions
        'X-Requested-With' // common XHR header
    ]
}));
