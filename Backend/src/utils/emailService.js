...
const sendContactUsEmail = async (senderName, senderEmail, subject, message) => {
    const apiKey = process.env.BREVO_API_KEY;
...
module.exports = { sendResetPasswordEmail, sendPlanActivationEmail, sendOtpEmail, sendContactUsEmail };
