...
const AdminPanel = () => {
    ...
    return (
        <div
            ...
            style={{ fontFamily: "'Inter', sans-serif", background: '#000000', color: '#F3F3F5' }}
        >
            {/* ── SIDEBAR ─────────────────────────────────────────────── */}
            <aside className="w-64 flex-shrink-0 flex flex-col h-screen"
                ...
                {/* Logo */}
                <div className="p-6" style={{ borderBottom: '1px solid #1a1a1e' }}>
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <h1 className="text-white text-lg font-bold leading-none">CodePrep</h1>
                            <p className="text-xs mt-1" style={{ color: '#4a4a52' }}>Admin Console</p>
                        </div>
                    </div>
                </div>
                ...
                <nav className="flex-1 p-4 space-y-1">
                    <button
                        ...
                        className={`w-full flex items-center gap-3 px-3 py-2 rounded-md transition-all text-sm font-semibold text-left ${
                            activePage === 'problems'
                                ? 'text-white border'
                                : 'hover:bg-white/5'
                        }`}
                        style={activePage === 'problems' ? { background: 'rgba(255,79,0,0.1)', borderColor: 'rgba(255,79,0,0.2)' } : { color: '#8A8B91' }}
                    >
                        <span className="material-symbols-outlined text-[20px]" style={{ color: activePage === 'problems' ? '#FF4F00' : '#8A8B91' }}>code</span>
                        <span>Problems</span>
                    </button>
                ...
                <div className="p-4" style={{ borderTop: '1px solid #1a1a1e' }}>
                    <div className="flex items-center gap-3 p-2 rounded-lg hover:bg-white/5 transition-colors cursor-pointer">
                        ...
                        <div className="flex-1 min-w-0">
                            ...
                            <p className="text-xs truncate" style={{ color: '#4a4a52' }}>{user?.emailId || 'admin@codeprep.io'}</p>
                        </div>
                    </div>
                </div>
            </aside>
            ...
            {/* ── MAIN ────────────────────────────────────────────────── */}
            <main className="flex-1 flex flex-col h-screen overflow-hidden" style={{ background: '#000000' }}>

                {/* ── Header ────────────────────────────────────────── */}
                <header className="flex justify-between items-center gap-4 px-8 py-5 sticky top-0 z-20"
                    style={{ background: '#0C0C0D', borderBottom: '1px solid #1a1a1e', backdropFilter: 'blur(12px)' }}>
                    <div>
                        <nav className="flex text-sm mb-1 items-center gap-1.5" style={{ color: '#8A8B91' }}>
                            <Link to="/" className="hover:text-white transition-colors">Dashboard</Link>
                            <span style={{ color: '#4a4a52' }}>/</span>
                            <span className="font-medium capitalize text-white">{activePage}</span>
                        </nav>
                        <h2 className="text-2xl font-black text-white">
                            {activePage === 'home' ? 'Dashboard' : 'Problems Management'}
                        </h2>
                        <p className="text-sm mt-0.5" style={{ color: '#8A8B91' }}>
                            {activePage === 'home'
                    ...
                    {activePage === 'problems' && (
                        <div className="flex gap-3">
                            <button
                                onClick={openCreate}
                                className="btn-rc-primary py-2 px-4 text-sm"
                            >
                ...
                <div className="flex-1 overflow-y-auto p-8">
                    ...
                    {activePage === 'problems' && (
                        <>
                            ...
                            <div className="flex flex-col md:flex-row gap-4 mb-6 items-center justify-between">
                                <div className="relative flex-1 w-full max-w-md">
                                    ...
                                    <input
                                        ...
                                        className="w-full bg-[#0C0C0D] border border-[#222225] rounded-md py-2 pl-10 pr-4 text-sm text-white placeholder-slate-500 focus:outline-none focus:border-[#FF4F00] focus:ring-1 focus:ring-[#FF4F00] transition-all"
                            ...
                            {/* Table */}
                            <div className="rounded-xl overflow-hidden" style={{ background: '#0C0C0D', border: '1px solid #222225' }}>
                                <div className="overflow-x-auto">
                                    <table className="w-full text-left text-sm">
                                        <thead className="border-b" style={{ background: '#111112', borderColor: '#222225', color: '#8A8B91' }}>
                                            <tr>
                                        ...
                                        <tbody className="divide-y divide-[#1c1c1f]">
                                            {listLoading ? (
                                                    ...
                                                    <tr key={i}>
                                                        <td colSpan={5} className="px-8 py-4">
                                                            <div className="flex items-center gap-6 animate-pulse">
                                                                <div className="h-3 w-10 bg-[#222225] rounded" />
                                                                <div className="h-3 flex-1 bg-[#222225] rounded" />
                                                                <div className="h-5 w-16 bg-[#222225] rounded-full" />
                                                                <div className="h-3 w-24 bg-[#222225] rounded" />
                                                                <div className="h-7 w-16 bg-[#222225] rounded" />
                                                            </div>
                                                        </td>
                                                    </tr>
                                                ))
                                                ...
                                                <tr>
                                                    <td colSpan={5} className="text-center py-12 text-[#8A8B91]">
                                                        <span className="material-symbols-outlined text-4xl block mb-2">search_off</span>
                                                        No problems found
                                                    </td>
                                                </tr>
                                            ) : filtered.map((p, idx) => (
                                                <tr key={p._id} className="hover:bg-[#111112] transition-colors group">
                                                    <td className="px-6 py-4 pl-8 text-slate-500 font-mono text-xs">{idx + 1}</td>
                                                    <td className="px-6 py-4">
                                                        <div
                                                            className="font-semibold text-white group-hover:text-[#FF4F00] transition-colors cursor-pointer"
                                                            onClick={() => openEdit(p)}
                                                        >
                                                            {p.title}
                                                        </div>
                                                    ...
                                                    <td className="px-6 py-4">
                                                        <div className="flex flex-wrap gap-1.5">
                                                            {(p.tags || []).slice(0, 3).map(tag => (
                                                                <span key={tag} className="px-2 py-0.5 rounded text-xs border" style={{ background: '#000000', color: '#8A8B91', borderColor: '#1c1c1f' }}>
                                                                    {tag}
                                                                </span>
                                                            ))}
                                                            {(p.tags || []).length > 3 && (
                                                    ...
                                                    <td className="px-6 py-4 pr-8 text-right">
                                                        <div className="flex justify-end gap-1">
                                                            <button
                                                                onClick={() => openEdit(p)}
                                                                className="p-2 text-[#8A8B91] hover:text-white hover:bg-white/5 rounded-md transition-colors"
                                                                title="Edit"
                                                            >
                                                            ...
                                                            <button
                                                                ...
                                                                className="p-2 text-[#8A8B91] hover:text-red-500 hover:bg-red-500/10 rounded-md transition-colors"
                                                                title="Delete"
                                                            >
                                ...
                                <div className="px-6 py-4 border-t flex items-center justify-between" style={{ background: '#111112', borderColor: '#222225' }}>
                                    <div className="text-sm text-[#8A8B91]">
                                    ...
                                    <div className="flex items-center gap-2">
                                        <button
                                            ...
                                            className="flex items-center gap-1 px-3 py-1.5 text-sm font-medium rounded-md border disabled:opacity-40 disabled:cursor-not-allowed transition-all hover:bg-white/5"
                                            style={{ background: '#0C0C0D', color: '#8A8B91', borderColor: '#222225' }}
                                        >
                                            ...
                                            .map((p, idx, arr) => (
                                                <React.Fragment key={p}>
                                                    ...
                                                    <button
                                                        ...
                                                        className={`w-8 h-8 text-sm font-bold rounded-md transition-all border ${
                                                            p === currentPage
                                                                ? 'bg-[#FF4F00] text-white border-[#FF4F00]'
                                                                : 'text-[#8A8B91] border-[#222225] hover:bg-white/5'
                                                        }`}
                                                        style={{ background: p === currentPage ? '#FF4F00' : '#0C0C0D' }}
                                                    >
                                                        {p}
                                                    </button>
                                                </React.Fragment>
            ...
            {modalOpen && (
                <div
                    className="fixed inset-0 z-50 flex items-center justify-center p-4 backdrop-blur-md bg-black/60 transition-all opacity-100"
                    onClick={e => { if (e.target === e.currentTarget) closeModal(); }}
                >
                    <div
                        className="w-full max-w-6xl flex flex-col rounded-2xl border overflow-hidden transform scale-100 transition-all"
                        style={{ maxHeight: '90vh', background: '#0C0C0D', borderColor: '#222225' }}
                    >
                        {/* Modal header */}
                        <div className="flex items-center justify-between p-6 flex-shrink-0" style={{ background: '#111112', borderBottom: '1px solid #1c1c1f' }}>
                            <div>
                                <h3 className="text-xl font-bold text-white"
                                    style={{ fontFamily: "'Space Grotesk', sans-serif" }}>
                                    {editingProblem ? 'Edit Problem' : 'Add Problem'}
                                </h3>
                                <p className="text-[#8A8B91] text-sm mt-1">Define problem details, test cases, and solution code.</p>
                            </div>
                            <button
                                onClick={closeModal}
                        ...
                        <form
                            ...
                            style={{ minHeight: 0, background: '#0C0C0D' }}
                        >
                            {/* Loading overlay while fetching problem details */}
                            {modalLoading ? (
                                <div className="flex-1 flex flex-col items-center justify-center gap-4" style={{ background: '#0C0C0D' }}>
                                    <span className="w-10 h-10 border-4 border-t-transparent rounded-full animate-spin" style={{ borderColor: '#FF4F00', borderTopColor: 'transparent' }} />
                                    <p className="text-[#8A8B91] font-medium text-sm mt-2">Loading problem details…</p>
                                </div>
                            ) : (
                            <div className="flex-1 overflow-y-auto p-8" style={{ background: '#000000' }}>
                                <div className="grid grid-cols-1 xl:grid-cols-2 gap-8">
                                    ...
                                    <div className="space-y-8">
                                        ...
                                        {/* Basic info card */}
                                        <div className="rounded-xl p-6 border" style={{ background: '#0C0C0D', borderColor: '#222225' }}>
                                            <h4 className="text-white font-bold mb-5 flex items-center gap-2">
                                                <span className="material-symbols-outlined text-[#FF4F00]">info</span>
                                                Basic Information
                                            </h4>
                                            <div className="space-y-5">
                                                {/* Title */}
                                                <div>
                                                    <label className="block text-sm font-bold text-slate-400 mb-1.5">Problem Title</label>
                                                    <input
                                                        {...register('title')}
                                                        className="w-full bg-[#111112] border border-[#222225] rounded-lg p-2.5 text-white placeholder-slate-500 focus:ring-1 focus:ring-[#FF4F00] focus:border-[#FF4F00] focus:outline-none transition-all shadow-sm"
                                                ...
                                                {/* Difficulty */}
                                                <div>
                                                    <label className="block text-sm font-bold text-slate-400 mb-1.5">Difficulty</label>
                                                    <select
                                                        {...register('difficulty')}
                                                        className="w-full bg-[#111112] border border-[#222225] rounded-lg p-2.5 text-white focus:ring-1 focus:ring-[#FF4F00] focus:border-[#FF4F00] focus:outline-none transition-all shadow-sm font-medium"
                                                ...
                                                {/* Tags */}
                                                <div>
                                                    <label className="block text-sm font-bold text-slate-400 mb-1.5">Tags</label>
                                                    <div className="w-full bg-[#111112] border border-[#222225] rounded-lg px-3 py-2 flex flex-wrap gap-2 items-center min-h-[46px] focus-within:ring-1 focus-within:ring-[#FF4F00] focus-within:border-[#FF4F00] transition-all shadow-sm">
                                                        {(watch('tags') || []).map((tag, i) => (
                                                            <span key={i} className="bg-[rgba(255,79,0,0.15)] text-[#FF4F00] border border-[rgba(255,79,0,0.2)] px-2.5 py-1 rounded text-xs flex items-center gap-1 font-bold">
                                                                {tag}
                                                ...
                                                {/* Description */}
                                                <div>
                                                    <label className="block text-sm font-bold text-slate-400 mb-1.5">Description (Markdown)</label>
                                                    <div className="border shadow-sm rounded-lg overflow-hidden focus-within:ring-1 focus-within:ring-[#FF4F00] focus-within:border-[#FF4F00] transition-all" style={{ borderColor: '#222225' }}>
                                                        <div className="flex items-center gap-1 p-2 border-b" style={{ background: '#111112', borderColor: '#222225' }}>
                                                            <button type="button" onClick={() => insertFormatting('<b>', '</b>')} className="p-1.5 hover:bg-white/5 rounded text-slate-400 hover:text-white transition-colors">
                                                                <span className="material-symbols-outlined text-sm">format_bold</span>
                                                            </button>
                                                            <button type="button" onClick={() => insertFormatting('<i>', '</i>')} className="p-1.5 hover:bg-white/5 rounded text-slate-400 hover:text-white transition-colors">
                                                                <span className="material-symbols-outlined text-sm">format_italic</span>
                                                            </button>
                                                            <button type="button" onClick={() => insertFormatting('<code>', '</code>')} className="p-1.5 hover:bg-white/5 rounded text-slate-400 hover:text-white transition-colors">
                                                                <span className="material-symbols-outlined text-sm">code</span>
                                                            </button>
                                                            <button type="button" onClick={() => setPreviewMode(p => !p)}
                                                                className={`ml-auto p-1.5 hover:bg-white/5 rounded transition-colors ${previewMode ? 'text-[#FF4F00] bg-[rgba(255,79,0,0.15)] font-bold' : 'text-slate-400 hover:text-white'}`}>
                                                        ...
                                                        {previewMode ? (
                                                            <div
                                                                className="p-4 text-white text-sm min-h-[160px] prose prose-invert prose-sm max-w-none bg-black font-medium"
                                                            ...
                                                            <textarea
                                                                ...
                                                                className="w-full bg-[#000000] p-4 text-white focus:outline-none resize-none font-mono text-sm"
                                        ...
                                        {/* Video Configuration: Link and Upload */}
                                        <div className="rounded-xl p-6 mb-8 border" style={{ background: '#0C0C0D', borderColor: '#222225' }}>
                                            <h4 className="text-white font-bold mb-5 flex items-center gap-2">
                                                <span className="material-symbols-outlined text-[#FF4F00]">video_call</span>
                                                Video Solution
                                            </h4>
                                            ...
                                            <div className="space-y-6">
                                                {/* Option 1: URL */}
                                                <div>
                                                    <label className="block text-sm font-semibold text-slate-400 mb-1.5">1. Video URL (YouTube, Vimeo, etc.)</label>
                                                    <input
                                                        {...register('videoUrl')}
                                                        className="w-full bg-[#111112] border border-[#222225] rounded-lg p-2.5 text-white placeholder-slate-500 focus:ring-1 focus:ring-[#FF4F00] focus:border-[#FF4F00] focus:outline-none transition-all shadow-sm"
                                                    ...
                                                    <p className="text-xs mt-1.5" style={{ color: '#8A8B91' }}>Enter an external video link to display in the editorial section.</p>
                                                </div>

                                                <div className="relative flex items-center py-2">
                                                    <div className="flex-grow border-t" style={{ borderColor: '#1c1c1f' }}></div>
                                                    <span className="flex-shrink-0 mx-4 text-xs font-bold uppercase tracking-wider" style={{ color: '#4a4a52' }}>OR</span>
                                                    <div className="flex-grow border-t" style={{ borderColor: '#1c1c1f' }}></div>
                                                </div>

                                                {/* Option 2: Upload */}
                                                <div>
                                                    <label className="block text-sm font-semibold text-slate-400 mb-1.5">2. Direct Upload</label>
                                        ...
                                        <div className="rounded-xl p-6 border" style={{ background: '#0C0C0D', borderColor: '#222225' }}>
                                            <div className="flex items-center justify-between mb-5">
                                                <h4 className="text-white font-bold flex items-center gap-2">
                                                    <span className="material-symbols-outlined text-[#FF4F00]">visibility</span>
                                                    Visible Test Cases
                                                </h4>
                                                <button
                                                    type="button"
                                                    onClick={() => appendVisible({ input: '', output: '', explanation: '' })}
                                                    className="text-xs bg-[rgba(255,79,0,0.15)] text-[#FF4F00] hover:bg-[rgba(255,79,0,0.25)] px-3 py-1.5 rounded-full font-bold transition-colors border border-[rgba(255,79,0,0.2)]"
                                                >
                                                    + Add Case
                                                </button>
                                            </div>
                                            <div className="space-y-4">
                                                {visibleFields.map((field, index) => (
                                                    <div key={field.id} className="p-5 rounded-lg border relative group transition-colors shadow-sm animate-fadeIn" style={{ background: '#111112', borderColor: '#222225' }}>
                                                        <button
                                                            type="button"
                                                            onClick={() => removeVisible(index)}
                                                            className="absolute top-3 right-3 text-slate-500 hover:text-red-500 opacity-0 group-hover:opacity-100 transition-opacity p-1.5 rounded hover:bg-white/5"
                                                        >
                                                            <span className="material-symbols-outlined text-[18px]">delete</span>
                                                        </button>
                                                        <p className="text-xs text-[#8A8B91] font-mono font-bold uppercase tracking-wider mb-4 border-b pb-2 inline-block" style={{ borderColor: '#1c1c1f' }}>Case #{index + 1}</p>
                                                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                                            <div>
                                                                <span className="text-xs text-slate-400 uppercase font-bold tracking-wider mb-1.5 block">Input</span>
                                                                <textarea
                                                                    {...register(`visibleTestCases.${index}.input`)}
                                                                    className="w-full bg-[#000000] border border-[#222225] rounded-md p-2.5 text-xs font-mono text-white focus:outline-none resize-none focus:border-[#FF4F00] transition-colors focus:ring-1 focus:ring-[#FF4F00]"
                                                                    rows={3}
                                                                />
                                                            ...
                                                            <div>
                                                                <span className="text-xs text-slate-400 uppercase font-bold tracking-wider mb-1.5 block">Output</span>
                                                                <textarea
                                                        ...
                                                        <div className="mt-4">
                                                            <span className="text-xs text-slate-400 uppercase font-bold tracking-wider mb-1.5 block">Explanation</span>
                                                            <input
                                                                {...register(`visibleTestCases.${index}.explanation`)}
                                                                className="w-full bg-[#000000] border border-[#222225] rounded-md p-2.5 text-xs text-white focus:outline-none focus:border-[#FF4F00] transition-colors focus:ring-1 focus:ring-[#FF4F00]"
                                    ...
                                    <div className="space-y-8">
                                        ...
                                        <div className="rounded-xl p-6 border" style={{ background: '#0C0C0D', borderColor: '#222225' }}>
                                            <h4 className="text-white font-bold mb-5 flex items-center gap-2">
                                                <span className="material-symbols-outlined text-[#FF4F00]">code_blocks</span>
                                                Start Code (Boilerplate)
                                            </h4>
                                            <div className="space-y-4">
                                                {startCodeFields.map((field, index) => (
                                                    <div key={field.id} className="flex flex-col rounded-lg border overflow-hidden shadow-sm" style={{ background: '#111112', borderColor: '#222225' }}>
                                                        <div className="flex items-center justify-between px-4 py-2 border-b" style={{ background: '#18181a', borderColor: '#222225' }}>
                                                            <select
                                                                {...register(`startCode.${index}.language`)}
                                                                className="bg-transparent text-xs text-white font-bold focus:outline-none cursor-pointer rounded"
                                                                style={{ colorScheme: 'dark' }}
                                                            >
                                                            ...
                                                            <button type="button" onClick={() => removeStart(index)} className="text-slate-500 hover:text-red-500 transition-colors p-1 rounded hover:bg-white/5">
                                                                <span className="material-symbols-outlined text-[16px]">close</span>
                                                            </button>
                                                        </div>
                                                        <textarea
                                                            {...register(`startCode.${index}.initialCode`)}
                                                            className="flex-1 p-4 bg-[#000000] font-mono text-xs text-white focus:outline-none resize-none leading-relaxed"
                                                            rows={6}
                                                ...
                                                <button
                                                    ...
                                                    className="w-full py-2.5 border border-dashed rounded-lg text-slate-400 hover:text-[#FF4F00] hover:border-[#FF4F00] hover:bg-white/5 flex items-center justify-center gap-2 text-xs font-bold transition-all"
                                                    style={{ borderColor: '#222225', background: '#111112' }}
                                                >
                                        ...
                                        <div className="rounded-xl p-6 border" style={{ background: '#0C0C0D', borderColor: '#222225' }}>
                                            <h4 className="text-white font-bold mb-5 flex items-center gap-2">
                                                <span className="material-symbols-outlined text-[#FF4F00]">settings_applications</span>
                                                Driver Code (Judge0 Execution)
                                            </h4>
                                            <div className="text-xs mb-4 p-3 rounded-lg border" style={{ background: '#111112', borderColor: '#222225', color: '#8A8B91' }}>
                                                Code here wraps the user's code for execution. Use <code className="font-bold bg-[#000000] px-1 py-0.5 rounded border border-[#222225]" style={{ color: '#white' }}>{'{{USER_CODE}}'}</code> where the user's Start Code will be injected.
                                            </div>
                                            <div className="space-y-4">
                                                {driverCodeFields.map((field, index) => (
                                                    <div key={field.id} className="flex flex-col rounded-lg border overflow-hidden shadow-sm" style={{ background: '#111112', borderColor: '#222225' }}>
                                                        <div className="flex items-center justify-between px-4 py-2 border-b" style={{ background: '#18181a', borderColor: '#222225' }}>
                                                            ...
                                                            <button type="button" onClick={() => removeDriver(index)} className="text-slate-500 hover:text-red-500 transition-colors p-1 rounded hover:bg-white/5">
                                                                <span className="material-symbols-outlined text-[16px]">close</span>
                                                            </button>
                                                        </div>
                                                        <textarea
                                        ...
                                        <div className="rounded-xl p-6 border" style={{ background: '#0C0C0D', borderColor: '#222225' }}>
                                            <h4 className="text-white font-bold mb-5 flex items-center gap-2">
                                                <span className="material-symbols-outlined text-[#FF4F00]">check_circle</span>
                                                Reference Solution
                                            </h4>
                                            <div className="space-y-4">
                                                {refFields.map((field, index) => (
                                                    <div key={field.id} className="flex flex-col rounded-lg border overflow-hidden shadow-sm" style={{ background: '#111112', borderColor: '#222225' }}>
                                                        <div className="flex items-center justify-between px-4 py-2 border-b" style={{ background: '#18181a', borderColor: '#222225' }}>
                                                            ...
                                                            <button type="button" onClick={() => removeRef(index)} className="text-slate-500 hover:text-red-500 transition-colors p-1 rounded hover:bg-white/5">
                                                                <span className="material-symbols-outlined text-[16px]">close</span>
                                                            </button>
                                                        </div>
                                                        <textarea
                                        ...
                                        <div className="rounded-xl p-6 border" style={{ background: '#0C0C0D', borderColor: '#222225' }}>
                                            <div className="flex items-center justify-between mb-5">
                                                <h4 className="text-white font-bold flex items-center gap-2">
                                                    <span className="material-symbols-outlined text-[#FF4F00]">lock</span>
                                                    Hidden Test Cases
                                                </h4>
                                                <button
                                                    type="button"
                                            ...
                                            <div className="space-y-4">
                                                {hiddenFields.map((field, index) => (
                                                    <div key={field.id} className="p-5 rounded-lg border border-l-4 relative group transition-colors shadow-sm animate-fadeIn" style={{ background: '#111112', borderColor: '#222225', borderLeftColor: '#FF4F00' }}>
                                                        <button
                                                            type="button"
                                                        ...
                                                        <p className="text-xs text-[#8A8B91] font-mono font-bold uppercase tracking-wider mb-4 border-b pb-2 inline-block" style={{ borderColor: '#1c1c1f' }}>Hidden Case #{index + 1}</p>
                                                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                                            <div>
                                                                <span className="text-xs text-slate-400 uppercase font-bold tracking-wider mb-1.5 block">Input</span>
                                                                <textarea
                            ...
                            {/* Modal footer */}
                            <div className="p-6 border-t flex items-center justify-between rounded-b-xl flex-shrink-0" style={{ background: '#111112', borderColor: '#1c1c1f' }}>
                                <label className="relative inline-flex inline-flex items-center cursor-pointer gap-2">
                                    <div className="relative">
                                        ...
                                        />
                                        <div className="w-10 h-5 bg-[#222225] peer-focus:outline-none rounded-full peer peer-checked:after:translate-x-5 peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-600 after:border after:rounded-full after:h-4 after:w-4 after:transition-all peer-checked:bg-[#FF4F00] shadow-inner" />
                                    </div>
                                    <span className="text-sm font-bold text-slate-300 select-none">Publish Immediately</span>
                                </label>

                                {statusMessage && (
                                    <span className={`text-sm font-bold px-3 py-1 rounded-full ${statusMessage.includes('Error') ? 'bg-red-500/10 text-red-500' : 'bg-green-500/10 text-green-500'}`}>
                                        {statusMessage}
                                    </span>
                                )}
                                ...
                                <div className="flex gap-3">
                                    <button
                                        type="button"
                                        onClick={closeModal}
                                        className="px-5 py-2.5 rounded-lg border border-[#222225] text-[#8A8B91] hover:text-white hover:bg-white/5 font-bold transition-all shadow-sm"
                                    ...
                                    <button
                                        type="submit"
                                        disabled={isLoading}
                                        className="px-5 py-2.5 rounded-lg text-white font-bold shadow-md hover:brightness-110 transition-all flex items-center gap-2 disabled:opacity-60"
